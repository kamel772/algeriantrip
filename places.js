...
const PLACES = [
    ...
    story: "La Mosquée de la Tobana est un joyau caché du vieux Mostaganem. Son minaret hexagonal, unique en Algérie, intrigue les visiteurs. Pourquoi cette forme ? La légende raconte que le sultan Abou Al-Hassan, fasciné par les mathématiques, voulait un minaret qui symbolise l'harmonie entre le carré terrestre et le cercle céleste. Six côtés, c'était la perfection.",
    ...
    audio: "audio/mosquee-tobana.mp3",
    ...
    story: "Ce mausolée abrite la dépouille du Bey Mostapha Bouchlaghem, figure emblématique de Mostaganem. Né en 1737, il gouverna la région avec sagesse et fermeté. Son tombeau, surmonté d'une coupole blanche, est un lieu de recueillement et de mémoire. Les habitants du quartier Tigditt viennent encore y allumer des bougies les soirs de fête.",
    address: "Quartier Tigditt",
    images: normalizeImages(["./images/bouchlaghem/bouchlaghem.jpg"]),
    audio: "audio/mausolee-bouchlaghem.mp3",
    ...
    story: "Saviez-vous que Mostaganem cache des vestiges romains ? À quelques kilomètres, les ruines de Quiza témoignent du passé antique de la région. On y a retrouvé des mosaïques, des pièces de monnaie et des stèles funéraires. Les archéologues pensent que Quiza était un important port de commerce entre l'Afrique romaine et l'Hispanie.",
    address: "Belatar",
    images: normalizeImages(["./images/quiza/1_1.jpg", "./images/quiza/images (13).jpeg"]),
    audio: "audio/quiza.mp3",
    ...
    description: "Ancien palais ottoman du XVIIIe siècle...",
    story: "Le Palais du Bey est bien plus qu'un simple bâtiment...",
    phone: "+213 45 30 12 34",
    address: "Place du 1er Novembre, Mostaganem",
    ...
    audio: "audio/palais-du-bey.mp3",
    latitude: 35.932, longitude: 0.088,
    vtc: "https://yassir.io/ride?dropoff_lat=35.932&dropoff_lon=0.088"  // ← AJOUTER ICI
    },
    {
    id: 6, name: "Fort de l'Est", category: "site",
    description: "Fortification ottomane restaurée par Hamid al-Abd.",
    story: "Perché sur sa falaise, le Fort de l'Est veille sur la baie de Mostaganem depuis plus de 400 ans. Construit par les Ottomans pour repousser les invasions, il fut ensuite renforcé par le légendaire Hamid al-Abd. Les canons qui pointent encore vers la mer rappellent les batailles navales d'antan. Au crépuscule, la vue depuis ses remparts est à couper le souffle.",
    ...
    story: "Flâner dans les ruelles de Tijdit, c'est remonter le temps. Les maisons blanchies à la chaux, les portes bleues ornées de clous, les fontaines publiques où se retrouvent encore les anciens... Ce quartier est l'âme de Mostaganem. La Zaouïa al-Alaouia, fondée en 1909, est un haut lieu de spiritualité soufie, connu dans le monde entier pour ses chants de samaâ.",
    address: "Tidjdit",
    ...
    // ========== NATURE (FORÊTS & RANDONNÉES) ==========
    {
        id: 90, name: "Forêt de Stidia", category: "nature",
        description: "Une magnifique forêt de pins maritimes longeant la côte, avec des sentiers balisés.",
        story: "La forêt de Stidia a été plantée au début du XXe siècle pour stabiliser les dunes côtières. Aujourd'hui, elle offre un refuge à de nombreuses espèces d'oiseaux migrateurs. Les anciens racontent que des contrebandiers y cachaient leur butin dans des grottes aujourd'hui disparues.",
        address: "Stidia, Mostaganem",
        images: [],
        audio: "audio/foret-stidia.mp3",
        latitude: 35.8300, longitude: 0.0100
    },
    {
        id: 91, name: "Randonnée du Cap Ivi", category: "nature",
        description: "Sentier côtier offrant des panoramas spectaculaires sur la Méditerranée. Durée : 2h30.",
        address: "Cap Ivi, Mostaganem",
        images: [],
        latitude: 36.1113, longitude: 0.2191
    },
    {
        id: 92, name: "Forêt de Aïn Nouissy", category: "nature",
        description: "Vaste forêt de pins d'Alep, idéale pour les randonnées familiales et les pique-niques.",
        address: "Aïn Nouissy, Mostaganem",
        images: [],
        latitude: 35.8200, longitude: 0.2100
    }
];
